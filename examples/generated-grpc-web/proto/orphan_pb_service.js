...
function OrphanServicePromiseClient(serviceHost, credentials, options) {
  this.client = new OrphanServiceClient(serviceHost, credentials, options);
}
...
exports.OrphanServicePromiseClient = OrphanServicePromiseClient;
