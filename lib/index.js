...
util_1.withAllStdIn(function (inputBuff) {
    try {
        ...
        var generatePromiseServices_1 = service === parameters_1.ServiceParameter.GrpcWebPromises;
        ...
        codeGenRequest.getFileToGenerateList().forEach(function (fileName) {
            ...
            if (generatePromiseServices_1) {
                grpcweb_1.generateGrpcWebPromiseServices(outputFileName, fileNameToDescriptor_1[fileName], exportMap_1)
                    .forEach(function (file) { return codeGenResponse_1.addFile(file); });
            }
            if (generateGrpcNodeServices_1) {
